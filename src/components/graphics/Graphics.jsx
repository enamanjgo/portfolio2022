      ...
      <div class="container text-light fw-light">
        <div className="row text-light fw-light">
          <h5 class="text-light fw-light">
            A collection of promotional graphic designs
          </h5>
          <p>Tools: Adobe Photoshop, Illustrator, Procreate, Canva</p>
        </div>

        <div class="row d-flex flex-wrap align-items-center">
          <div class="col-12 col-md-6 col-lg-6 ">
            <img src="https://i.imgur.com/t8czRnZ.png" alt="" />
          </div>
          <div class="col-12 col-md-6 col-lg-6 ">
            <img src="https://i.imgur.com/Six0TWk.jpg" class="" alt="" />
          </div>
          <div class="col-12 col-md-6 col-lg-6">
            <img src="https://i.imgur.com/RUKXdoo.png" class="p-5" alt="" />
          </div>
          <div class="col-12 col-md-6 col-lg-6 ">
            <img src="https://i.imgur.com/pmB99Rl.png" class="p-5" alt="" />
          </div>
          <div class="col-12 col-md-6 col-lg-6">
            <img src="https://i.imgur.com/VewsMor.png" class="p-5" alt="" />
          </div>

          <div class="col-12 col-md-6 col-lg-6">
            <img src="https://i.imgur.com/7t6tO2d.png" class="p-5" alt="" />
          </div>
